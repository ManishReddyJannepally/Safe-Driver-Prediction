...
We got an accuracy of 85% with the above model. Using the variable importance, I included only the important variable and build models. But the accuracy seems to be fluctuvating just 0.2 - 0.3%.
...
```
##        0                1         
##  Min.   :0.1680   Min.   :0.1100  
##  1st Qu.:0.5480   1st Qu.:0.3280  
##  Median :0.6100   Median :0.3900  
##  Mean   :0.6079   Mean   :0.3921  
##  3rd Qu.:0.6720   3rd Qu.:0.4520  
##  Max.   :0.8900   Max.   :0.8320
```
